...
if __name__ == '__main__':
    postfix = 'jpg'
    img_path = r'E:\Python_Learn_Source\YOLO\yolov5_7.0_LightWeight_Head_Attention\TP-FP-FN\images'
    label_path = r'E:\Python_Learn_Source\YOLO\yolov5_7.0_LightWeight_Head_Attention\TP-FP-FN\labels'
