...
parser.add_argument('--root_dir', default='E:/Python_Learn_Source/YOLO\yolov5_7.0_LightWeight_Head_Attention_Loss/COCO_Datasets/', type=str,
...
def yolo2coco(arg):
    ...
    originLabelsDir = os.path.join(root_path, 'labels/val')
    originImagesDir = os.path.join(root_path, 'images/val')
