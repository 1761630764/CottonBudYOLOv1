...
def get_params():
    params = {
        'weight': r'E:\Python_Learn_Source\YOLO\yolov5_7.0_LightWeight_Head_Attention_Loss\runs\train\yolov5s_ShuffleNetv2_Dysample_ASFFHead_CBAMx4\weights\best.pt',
        'device': 'cpu',  # cuda:0
        ...
        'ratio': 0.02,  # 0.02-0.1  # 影响热图的细节和范围
        'show_box': False,
        'renormalize': False  # 将CAM归一化到边界框内
    }
    return params
