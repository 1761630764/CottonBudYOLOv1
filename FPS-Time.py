...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default=r'E:\Python_Learn_Source\YOLO\yolov5_7.0_LightWeight_Head_Attention_Loss\runs\train\yolov5s_ShuffleNetv2_Dysample_ASFFHead_GCx4\weights\best.pt', help='trained weights path')
